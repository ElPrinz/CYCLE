    ...
    public void InitGuis()
    {
        ...
        if (guisCreated == false)
        {
            if (DebugGui == null)  // If an external GUIText is not set, provide the default GUIText
            {
                ...
                DebugGui.AddComponent<UnityEngine.UI.Text>();
        ...
        else if (visible == true)
        {
            ...
            else
            {
                while (x < messages.Count)
                {
                    ...
                    {
                        case "normal":
                            gui.GetComponent<UnityEngine.UI.Text>().material.color = normal;
                            break;
                        case "warning":
                            gui.GetComponent<UnityEngine.UI.Text>().material.color = warning;
                            break;
                        case "error":
                            gui.GetComponent<UnityEngine.UI.Text>().material.color = error;
                            break;
                    }
